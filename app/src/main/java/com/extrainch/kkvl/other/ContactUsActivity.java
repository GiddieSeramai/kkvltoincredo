...
public class ContactUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = new MyPreferences(ContactUsActivity.this);
        ...
        binding.imBack.setOnClickListener(v -> startActivity(new Intent(this, Dashboard_increado.class)
    ...
    public void supremeSendMessage(String url) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url, jsonObject, response -> {
            ...
            try {
                ...
                Toast.makeText(ContactUsActivity.this, Log.getStackTraceString(e) + "", Toast.LENGTH_LONG).show();
