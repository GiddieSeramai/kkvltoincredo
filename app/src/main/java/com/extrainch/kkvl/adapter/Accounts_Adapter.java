...
public class Accounts_Adapter extends ArrayAdapter<String> {
    ...
    public Accounts_Adapter(Activity context, ArrayList<String> ac_Product, ArrayList<String> account_number, ArrayList<String> account_Bal) {
