...
public class Balances_Adapter extends ArrayAdapter<String> {
    ...
    public Balances_Adapter(Activity context, ArrayList<String> ac_Product, ArrayList<String> account_number, ArrayList<String> account_Bal) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.account_balances_adapter, null, true);
        ...
        // TextView tv_statement= rowView.findViewById(R.id.tv_statement);
